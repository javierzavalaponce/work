...
El Criterio de Routh-Hurwitz sirve para

* Determinar estabilidad de un sistema
sin calcular explícitamente las raíces del polinomio a partir de su ecuación característica.

El *algoritmo* de este criterio es:

1. Colocar el denominador (ec. caracteristica) ordenado de mayor a menor
sgún las potencias del polinomio
