...
La siguiente figura muestra un circuito RC y se modela por una ecuacion diferencial lineal ordinaria de primer orden.
...
Vea que el polinomio del denominador, tambien llamado **ecuación caracteristica** es de primer grado ( se dice que tiene un solo *polo* ).  
...
* Mientras los polos estén en el eje real, no hay oscilación
* Entre mas cerca queda el polo del eje imaginario, mas lento es el tiempo de extablecimiento
