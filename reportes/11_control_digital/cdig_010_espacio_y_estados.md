...
El *estado* $x$ (por ejemplo: la posición y velocidad de un péndulo) es una descripción
de un sistema.
...
El espacio de estados es un espacio vectorial (en el caso lineal de dimensión finita, $\mathbb{R^n}$), cuyos elementos son todos los estados posibles del sistema. Cada estado se representa mediante un vector cuyas componentes son sus coordenadas respecto a una base elegida.

Estrictamente, el espacio de estados es $\mathbb{R^n}$ (o un subespacio). Sus elementos son todos los estados posibles; el vector es la representación coordenada del estado respecto a una base. 
