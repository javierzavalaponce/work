...
#define BOARD_WIFI_CS_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_WIFI_CS_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_WIFI_CS_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                               /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_WIFI_SCK_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_WIFI_SCK_PIN 5U                   /*!<@brief PORT pin number */
#define BOARD_WIFI_SCK_PIN_MASK (1U << 5U)      /*!<@brief PORT pin mask */
                                                /* @} */
