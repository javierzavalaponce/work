...
#define USB_AUDIO_GENERATOR_CONTROL_INTERFACE_ALTERNATE_COUNT (1)
#define USB_AUDIO_GENERATOR_STREAM_INTERFACE_ALTERNATE_COUNT  (2)
#define USB_AUDIO_GENERATOR_CONTROL_INTERFACE_ALTERNATE_0     (0)
#define USB_AUDIO_GENERATOR_STREAM_INTERFACE_ALTERNATE_0      (0)
#define USB_AUDIO_GENERATOR_STREAM_INTERFACE_ALTERNATE_1      (1) 

#define USB_HID_MOUSE_INTERFACE_COUNT           (1)
#define USB_HID_MOUSE_INTERFACE_ALTERNATE_COUNT (1)
#define USB_HID_MOUSE_INTERFACE_ALTERNATE_0     (0)
