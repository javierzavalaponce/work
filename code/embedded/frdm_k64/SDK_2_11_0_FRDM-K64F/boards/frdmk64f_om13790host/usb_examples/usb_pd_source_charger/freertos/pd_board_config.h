...
#define PD_PORT1_PHY_INTERRUPT_PIN (12U)
...
#define PD_PORT1_EXTRA_SRC_PIN (23U)

#define PD_PORT1_EXTRA_SRC_PORT (1U)

#define PD_PORT1_SHIELD2_DP4LANE_PIN (9U)

#define PD_PORT1_SHIELD2_DP4LANE_PORT (1U)

#define PD_PORT1_SHIELD2_XSD_PIN (2U)

#define PD_PORT1_SHIELD2_XSD_PORT (0U)

#define PD_PORT1_SHIELD2_ORIENT_PIN (4U)

#define PD_PORT1_SHIELD2_ORIENT_PORT (2U)

#define PD_PORT1_SHIELD2_HPD_PIN (1U)

#define PD_PORT1_SHIELD2_HPD_PORT (0U)

#define PD_PORT1_POWER_REQUEST_SW_PIN (6U)

#define PD_PORT1_POWER_REQUEST_SW_PORT (2U)

#define PD_PORT1_POWER_CHANGE_SW_PIN (4U)
