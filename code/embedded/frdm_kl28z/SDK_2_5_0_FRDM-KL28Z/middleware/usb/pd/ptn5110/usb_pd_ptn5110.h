...
typedef struct __pd_phy_tcpc_instance_
{
    ...
    /* Current tx buffer, 0xFF for none, cleared to 0xFF on tx_done assertion,
       original usage: msg_tcpc.c, current usage: only internal */
    volatile uint8_t msgTxBufState;
    ...
    volatile uint8_t txHave : 1;
    volatile uint8_t rxHave : 1;
    volatile uint8_t cacheRxValid : 1;
    volatile uint8_t currentStable : 1;
    volatile uint8_t txAbort : 1;
