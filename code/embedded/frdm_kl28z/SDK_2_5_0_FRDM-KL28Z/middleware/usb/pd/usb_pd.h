...
typedef enum _pd_control
{
    ...
    /*! control vbus¡ê?set the type-c 5V vbus current ilim (OCP current) */
    PD_CONTROL_SET_TYPEC_CURRENT_ILIM,
    /*! get Type-C Rp current value */
